      ...
      <section className="hero">
        <div className="hero-panel">
          <div className="brand-row">
            <span className="brand-badge">Domain-Specific RAG</span>
            <span className="status-pill status-pill--ready">Chroma-scoped knowledge retrieval</span>
          </div>
          <h1>Domain Expert: {loading.loadingDomain ? 'Loading...' : domainProfile?.name}</h1>
          ...
          {domainProfile?.guidelines && (
            <p className="hero-copy">
              <strong>Guidelines:</strong> {domainProfile.guidelines}
            </p>
          )}
          <div className="stack-row">
            <span>React</span>
            <span>Express</span>
            <span>Domain-scoped retrieval</span>
